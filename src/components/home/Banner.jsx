...
const stats = [
  { label: "Xe đã bán", value: "5.200+" },
  { label: "Khách hàng", value: "12.000+" },
  { label: "Thương hiệu", value: "40+" },
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          ...
          <div className="text-white space-y-6">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <button
                ...
                className="flex items-center gap-2 bg-yellow-400 hover:bg-yellow-300 text-gray-900 font-semibold px-6 py-3 rounded-xl transition-all shadow-lg hover:shadow-yellow-400/30 hover:-translate-y-0.5"
              >
                Khám phá ngay
                <ArrowRight size={18} />
              </button>
              <button
                ...
                className="flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/30 text-white font-medium px-6 py-3 rounded-xl transition-all backdrop-blur-sm"
              >
                Đăng bán xe
              </button>
            </div>
          ...
          <div className="hidden lg:flex justify-center">
            <div className="relative w-full max-w-md aspect-square">
              ...
              <div className="absolute inset-8 bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 flex flex-col items-center justify-center gap-4 p-8">
                ...
                <span className="text-blue-200 text-sm">Được tin tưởng bởi 12.000+ khách hàng</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-4">
          {stats.map(({ label, value }) => (
            <div
              key={label}
              className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl px-6 py-4 text-center"
            >
