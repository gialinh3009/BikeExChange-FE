...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    // fake login — chuyển thẳng vào admin
    navigate("/admin");
  };
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm transition mt-2"
              >
                Đăng nhập
              </button>
            </form>
            ...
            >
              <svg width="18" height="18" viewBox="0 0 48 48">
                <path fill="#EA4335" d="M24 9.5c3.1 0 5.8 1.1 8 2.9l6-6C34.4 3.1 29.5 1 24 1 14.8 1 7 6.7 3.7 14.6l7 5.4C12.4 13.5 17.7 9.5 24 9.5z" />
                <path fill="#4285F4" d="M46.6 24.5c0-1.6-.1-3.1-.4-4.5H24v8.5h12.7c-.6 3-2.3 5.5-4.8 7.2l7.4 5.7c4.3-4 6.3-9.9 7.3-16.9z" />
                <path fill="#FBBC05" d="M10.7 28.4A14.6 14.6 0 0 1 9.5 24c0-1.5.3-3 .8-4.4l-7-5.4A23.9 23.9 0 0 0 .1 24c0 3.9.9 7.5 2.6 10.8l8-6.4z" />
                <path fill="#34A853" d="M24 47c5.5 0 10.1-1.8 13.4-4.9l-7.4-5.7c-1.8 1.2-4.2 2-6 2-6.3 0-11.6-4-13.3-9.5l-8 6.4C7 41.3 14.8 47 24 47z" />
              </svg>
              Tiếp tục với Google
            </button>
