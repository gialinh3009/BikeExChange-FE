...
function ScoreButton({
  ...
  const getColor = (v: number) => {
    if (v <= 3)
      return { active: "#dc2626", activeBg: "#fee2e2", hover: "#fecaca" };
    if (v <= 6)
      return { active: "#d97706", activeBg: "#fef3c7", hover: "#fde68a" };
    if (v <= 8)
      return { active: "#2563eb", activeBg: "#dbeafe", hover: "#bfdbfe" };
...
export default function CreateReportForm({
  ...
  const handleSubmit = async () => {
    if (
      !form.frameCondition.trim() ||
      !form.groupsetCondition.trim() ||
      !form.wheelCondition.trim()
    ) {
    ...
    try {
      const mediasToSubmit: MediaItem[] = [];
      ...
      >
        ...
        <div style={{ padding: "20px 24px" }}>
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            {(
              ["frameCondition", "groupsetCondition", "wheelCondition"] as const
            ).map((field) => (
